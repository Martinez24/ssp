...
<!-- Inician campos del formulario -->
                                    <div class="form-group">
                                      ...
                                      <select name="no_factura" class="form-control" required>
                                        <?php 
              ...
              <table class="table">
                ...
                <?php
                  ...
                  while ($proforma = mysql_fetch_assoc($resultado)) {
                    echo "<tr>";
                     echo "<td><a href='consultas.php?ver_proforma_id=".$proforma['id_proforma']."' class='btn btn-rounded btn-primary ver-proyecto' title='Realizar Pago' ><i class='fa fa-money'></i></a></td>";
